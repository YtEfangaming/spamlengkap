# Jangan Lupa Subscribe EFAN HACKER :)
...
def mr_x():
    time.sleep(1)
    os.system("clear")
    print (" Subrek YT EFAN HACKER Slurr, Gk Subrek Gk Kawan")
    time.sleep(1)
    os.system("xdg-open https://youtube.com/channel/UC_iySGq0SpEk9ZEl2AxlhIQ")
    time.sleep(5)
    os.system("clear")
